...
namespace ix
{
    ...
    private:
        bool attachConnectionIO(std::string& errMsg);
        ...
        static int socketBioWrite(BIO* bio, const char* data, int dataLen);
        static int socketBioRead(BIO* bio, char* data, int dataLen);
