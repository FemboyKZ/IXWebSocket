...
namespace ix
{
    ...
    protected:
        ...
        virtual int getSocketAcceptTimeoutSecs();
    ...
    private:
        ...
        std::thread _thread;
        void run();
        void runConnection(std::unique_ptr<Socket> socket,
        ...
        // Connection thread cleanup helpers.
        void closeTerminatedThreads();
        bool isCurrentThreadInConnectionThreads();
        bool detachCurrentConnectionThread();
